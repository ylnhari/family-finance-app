...
class ServerTests(unittest.TestCase):
    ...
    def test_cards_page_keeps_core_actions(self):
        ...
        self.assertIn('onclick="addCard()"', cards_page)
        self.assertIn('onclick="editCard(${i})"', cards_page)
        self.assertIn('onclick="toggleCardStatus(${i})"', cards_page)
        self.assertIn('onclick="delCard(${i})"', cards_page)
        self.assertIn("function toggleReveal", text)
