...
node --test tests/math.test.js tests/sample.test.js       # math and sample data
```
...
- **Expenses** — sections with predefined category & location dropdowns ("add new for reuse" or "custom for this entry"); each section can track location, person, or just category & amount. Mark outside help / family support sections as **External help received**; the single **With external help** comparison shows help-covered expenses and resulting savings while keeping in-hand income unchanged.
